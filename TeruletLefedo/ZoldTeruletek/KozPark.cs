...
{
    class KozPark : ZoldTerulet, IComparable
    {
        public KozPark(FeluletTipusok feluletTipus, double szelesseg, double magassag, int megrendeloID, int lefedettsegMin)
        {
