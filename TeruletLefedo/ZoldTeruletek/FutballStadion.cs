...
{
    class FutballStadion : ZoldTerulet, IComparable
    {
        public FutballStadion(FeluletTipusok feluletTipus, double szelesseg, double magassag, int megrendeloID, int lefedettsegMin)
        {
        ...
        {
            string mkStr = "A FutballStadion adatai:\n Tipus: " + FeluletTipus + "\n Szelesseg: " + Szelesseg + "\n Magassag: " + Magassag + "\n Terulet: " + Terulet;
            return mkStr;
        }
